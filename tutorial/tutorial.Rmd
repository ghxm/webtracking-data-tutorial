...
Note: The summary statistics don't include days where no browsing sessions took place!
...
Can you subdivide news visits into subcategories
(politics, sports, culture) using the `path` column? 
