...
The GESIS Web Tracking data contains only host-level information. We'll create an enhanced dataset with synthetic full URLs to practice URL parsing and classification. This takes 2-3 minutes on first run.
...
# TODO: Compare results - show sample of parsed URLs
```

**Key Concepts:**

- **Protocol**: `https://` or `http://`
- **Host**: Full hostname like `www.spiegel.de`
- **Domain**: Root domain like `spiegel.de`
- **Path**: Everything after domain, like `/politik/bundestagswahl-a-123456.html`
- **Query**: Parameters after `?`, like `?q=klimawandel&start=10`

**Try it yourself:** Can you extract just the top-level domain (`.de`, `.com`, `.org`) from the domain field?
